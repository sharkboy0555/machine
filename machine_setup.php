...
<body>
    ...
    <select id="modelSel">
      ...
      <?php else: ?>
        <?php foreach ($modelsData as $m): ?>
          <option value="<?php echo htmlspecialchars($m['Name'], ENT_QUOTES); ?>">
  ...
  <script>
  $(function(){
    // make modelsData available in JS
    var modelsCfg = <?php echo json_encode($modelsData, JSON_HEX_TAG); ?>;

    // update width/height and canvas size
    ...
    // Manual preview: draw locally and invoke overlay()
    $('#previewBtn').click(function(){
      ...
      // trigger overlay hook with all params
